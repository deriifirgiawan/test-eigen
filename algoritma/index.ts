...
// Hasil Nomor 2
const exampleLongest = longest(
	"Ini adalah contoh kalimat mencari kata terpanjang dalam sebuah kalimat tapi kalo ada kata dengan panjang yang sama akan di ambil salah satunya"
);
console.log(exampleLongest);

// Soal Nomor 3
const countQuery = (input: string[], query: string[]) => {
	const result = [];
...
// Soal no 4
const diagonal = (matrix: string | any[]) => {
	let diagonalOne = 0;
	let diagonalTwo = 0;
